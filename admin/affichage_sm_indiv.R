...
affichage1<-affichage[1:11]
affichage1<-affichage1[ order(affichage1$Classement), ]
# name.width <- max(sapply(names(affichage), nchar))
# names(affichage) <- format(names(affichage), width = name.width, justify = "centre")
# x<-format(affichage, width = name.width, justify = "centre")

#Affichage des adultes individuels 
